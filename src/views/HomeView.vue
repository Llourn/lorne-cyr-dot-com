    ...
    <main>
      <div class="text-container">
        ...
        <p>
          ...
          gameplay programming, building games/applications for several studios
          throughout the maritimes. I’ve since moved into web development,
          building online courses for the University of Fredericton and Vue apps
          for Battlesnake Inc. In my spare time I like to build projects related
          to other interests of mine, like learning Japanese. I also value
